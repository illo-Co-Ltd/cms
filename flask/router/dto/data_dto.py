...
class ImageMetadataDTO:
    ...
    model = api.model('image', {
        ...
        'end_x': fields.Integer(required=True, description='Calibrated x offset'),
        'end_y': fields.Integer(required=True, description='Calibrated y offset'),
        'end_z': fields.Integer(required=True, description='Calibrated z offset'),
